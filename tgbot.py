...
def init_db():
    ...
    ''')
    # NEW TABLE: To store users for broadcasting
    cursor.execute('''
...
# ================= 2. ADMIN TEXT HANDLER (Add/Edit/Del/Stock/Broadcast) =================
...
def send_welcome(message):
    register_user(message.chat.id) # Save user for broadcasting
